    ...
    <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-slate-100 pb-8">
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          <div>
            <p className="text-[10px] font-black uppercase leading-none mb-1 tracking-tight">
              Log Photo
            </p>
        ...
        >
          ...
          <div>
            <p className="text-[10px] font-bold text-slate-400 uppercase leading-none mb-1 tracking-tight">
              Daily Check-in
            </p>
            <p className="text-[9px] text-emerald-500 font-bold whitespace-nowrap">
              Keep Streak 🔥
            </p>
          </div>
        </motion.button>
