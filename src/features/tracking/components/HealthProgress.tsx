    ...
    <Card className="p-6 shadow-xl shadow-blue-500/5 border-none rounded-[2.5rem] bg-white h-full flex flex-col relative overflow-hidden min-h-[420px]">
      ...
      <div className="grid grid-cols-3 mt-14 pt-6 border-t border-slate-50 text-center">
        <div className="flex flex-col gap-1">
          <span className="text-[11px] font-semibold uppercase text-slate-400 tracking-tight">
            Stability
          </span>
          <span className="text-slate-700 text-[13px] font-normal italic leading-none">
            82% Accurate
          </span>
        </div>
        <div className="flex flex-col gap-1 border-x border-slate-50">
          ...
          <span className="text-[#67AEFF] text-[13px] font-normal italic leading-none">
            92% Daily
          </span>
        </div>
        <div className="flex flex-col gap-1">
          ...
          <span className="text-emerald-500 text-[13px] font-normal italic leading-none">
            90 Score
          </span>
        </div>
      </div>
