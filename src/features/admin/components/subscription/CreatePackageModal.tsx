...
interface Props {
  isOpen: boolean
  onClose: () => void
  onSubmit: (payload: CreatePackagePayload) => void
}
...
const CreatePackageModal = ({ isOpen, onClose, onSubmit }: Props) => {
          ...
          >
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md pointer-events-auto max-h-[88vh] overflow-y-auto">
              <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
                <h2 className="text-[15px] font-semibold text-gray-900">Create New Package</h2>
                <button
                  onClick={onClose}
