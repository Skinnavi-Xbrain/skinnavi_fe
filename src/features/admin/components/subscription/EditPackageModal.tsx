...
const DURATION_CONFIG: Record<DurationType, { days: number; weeklyScanLimit: number; label: string }> = {
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md pointer-events-auto max-h-[88vh] overflow-y-auto">
              <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
                ...
                <div className="flex items-center gap-2">
                  {initialData?.packageId && (
                    <span className="text-[11px] text-gray-400 font-mono">{initialData.packageId}</span>
                  )}
              ...
              <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
                ...
                <div>
                  ...
                  <input
                    required value={form.package_name}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs font-medium text-gray-600 mb-1.5">Price (VNĐ)</label>
                    <input
                  ...
                  <div>
                    ...
                    <select
                      value={form.duration}
                      onChange={(e) => setForm({ ...form, duration: e.target.value as DurationType })}
                ...
                <div className="flex items-center justify-between py-1">
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-0.5">Enable location & activity tracking</p>
                  </div>
                  <button
                    type="button"
                  ...
                  >
                    <span className={`absolute top-1 w-4 h-4 bg-white rounded-full shadow transition-all ${form.allow_tracking ? 'left-5' : 'left-1'}`} />
                  </button>
                </div>
