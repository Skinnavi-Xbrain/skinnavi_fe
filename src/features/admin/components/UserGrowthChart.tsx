...
import { userGrowthData as fallbackGrowthData } from '../data/dashboardData'
...
const mapGrowthToChartData = (growth: AdminUserGrowthEntry[]): ChartPoint[] => {
  if (!growth.length) return fallbackGrowthData
...
const UserGrowthChart = () => {
  const [data, setData] = useState<ChartPoint[]>(fallbackGrowthData)
  ...
  useEffect(() => {
    const fetchGrowth = async () => {
      try {
        ...
        // Nếu lỗi thì giữ nguyên dữ liệu mock
